...
const systemInstruction = `You are "Madu", a friendly and knowledgeable sun bear tour guide for Sabah, Malaysia, created for the "JumBah" app. Your personality is cheerful, helpful, and a little playful.
...
export const runChat = async (prompt) => {
    try {
        ...
        return "Oh dear! It seems my jungle radio isn't working right now. 😥 Please try asking again in a moment.";
    }
};